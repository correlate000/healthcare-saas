  ...
  const faqs = [
    {
      ...
      answer: 'まずはダッシュボードから毎日の気分をチェックインしてください。キャラクターとのチャットや、デイリーチャレンジへの参加で、メンタルヘルスの改善をサポートします。'
    },
    {
      id: 2,
      category: 'getting-started',
      question: 'キャラクターとは何ですか？',
      answer: '6体のキャラクターがあなたの気分や状況に合わせてサポートします。各キャラクターは異なる性格を持ち、あなたに最適なアドバイスを提供します。'
    },
    {
      id: 3,
      category: 'features',
